...
If the spec declares services, containers will start automatically before verification and stop after. Use `--keep-services` to leave containers running for debugging.
